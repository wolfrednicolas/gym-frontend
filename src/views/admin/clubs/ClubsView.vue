<template>
    ...
    <div class="col-lg-9 mt-4 mt-lg-0">
        <router-link to="/admin/clubs/new" class="btn btn-danger">Create</router-link>
        <div class="row">
          <div class="col-md-12">
            <div class="user-dashboard-info-box table-responsive mb-0 bg-white p-4 shadow-sm">
              <table class="table manage-candidates-top mb-0">
                ...
                <tbody>
                  <template v-if="clubs !== null && clubs.length > 0">
                    <tr class="candidates-list"  v-for="club in clubs" :key="club.email">
                    <td class="title">
                      <div class="thumb">
                      ...
                      <div class="candidate-list-details">
                        <div class="candidate-list-info">
                          <div class="candidate-list-title">
                            ...
                            <h5 class="mb-0"><a :href="'/club/' + club.id">{{ club.title }}</a></h5>
                          </div>
                    ...
                    <td>
                      <ul class="list-unstyled mb-0 d-flex justify-content-end">
                        <li><router-link :to="'/admin/clubs/' + club.id">View</router-link></li>
    ...
    onBeforeMount(async()  => {
      await userStore.getAllClubs();
      clubs.value = userStore.clubs;
    })
